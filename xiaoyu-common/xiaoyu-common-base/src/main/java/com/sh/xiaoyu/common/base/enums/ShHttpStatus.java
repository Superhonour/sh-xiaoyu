package com.sh.xiaoyu.common.base.enums;
...
public enum ShHttpStatus {
    ...
    ShHttpStatus(Integer code, String message) {
        this.code = code;
     ...
     * @return the enum
     */
    public static ShHttpStatus getEnum(int code) {
        for (ShHttpStatus ele : ShHttpStatus.values()) {
            if (ele.getCode() == code) {
                return ele;
            }
        }

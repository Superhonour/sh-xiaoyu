...
public class BaseController {
    ...
    public ApiResponse success(){
        return  new ApiResponse(ShHttpStatus.SUCCESS);
    }

    public ApiResponse success(String msg){
        ApiResponse re = new ApiResponse(ShHttpStatus.SUCCESS);
        re.setMessage(msg);
        return  re;
    }
    ...
    public ApiResponse fail(){
        return  new ApiResponse(ShHttpStatus.COMMON_FAIL);
    }

    public ApiResponse fail(String msg){
        ApiResponse re = new ApiResponse(ShHttpStatus.COMMON_FAIL);
        re.setMessage(msg);
        return  re;
    }

package com.sh.xiaoyu.common.log.aspect;
...
import com.sh.xiaoyu.common.log.event.SysLogEvent;
...
public class ApiLogAspect {
     ...
     * //@Pointcut("execution(public * com.sh.xiaoyu.*.*.controller.*.*(..) )")
     */
    @Pointcut("@annotation(com.sh.xiaoyu.common.log.annotation.SysLog)")
    public void log() {
